...
export const fetchAreas = createAsyncThunk("area/fetchAreas", async (_, thunkAPI) => {
  try {
    return await fetchAreasService();
  } catch (err) {
...
export const updateArea = createAsyncThunk("area/updateArea", async ({id, name, areas}, thunkAPI) => {
  try {
    console.log('update API');
    return await updateAreaService({id, name, areas});
  } catch (err) {
