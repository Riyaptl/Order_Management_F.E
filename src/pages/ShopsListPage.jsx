...
import { fetchAreas } from "../slice/areaSlice"; // You handle this
import { fetchShops, deleteShop, updateShop, createShop, exportCSVShop, shiftShop } from "../slice/shopSlice"; // You handle this
import Navbar from "../components/NavbarComponents";
import toast from "react-hot-toast";
import { FaTrash, FaEdit, FaExchangeAlt } from "react-icons/fa"; // Top of the file
...
const ShopsListPage = () => {
    ...
    return (
        <div className="p-4">
            ...
            <h2 className="text-2xl font-semibold text-amber-700 text-center mb-4">Shops List</h2>
